...
--    awful.layout.suit.spiral.dwindle,
    awful.layout.suit.max, -- place one window in display
    awful.layout.suit.max.fullscreen,
--    awful.layout.suit.magnifier -- place one window on center
}
-- }}}
...
for s = 1, screen.count() do
    ...
    datewidget:set_widget(systray)
    datewidget:set_bg("#222222")
...
--
--    awful.key({}, "Print", function () awful.util.spawn("~/bin/screenshot") end),
...
--    awful.key({ modkey, }, "p", function () awful.util.spawn_with_shell("~/bin/dmenu_root ~/bin/dmenu/window") end),
--    awful.key({ modkey, }, "Return", function () awful.util.spawn_with_shell("~/bin/dmenu_root ~/bin/dmenu/edit") end),
--    -- awful.key({ modkey, }, "r", function () awful.util.spawn_with_shell("~/bin/dmenu_root ~/bin/dmenu/notify") end),
--    awful.key({ modkey, }, "r", function () awful.util.spawn_with_shell("~/bin/dmenu_root ~/bin/dmenu/google") end),


--    awful.key({ modkey }, "a",
--              function ()
--                  awful.util.spawn_with_shell("~/bin/dmenu_root ~/bin/dmenu/run")
...
--              end),
    ...
    awful.key({ modkey }, "x", function() mywibox[mouse.screen].visible = not mywibox[mouse.screen].visible end)
)
