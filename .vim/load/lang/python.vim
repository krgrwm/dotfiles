...
" Slimux
autocmd FileType python vmap <buffer> <silent> <CR> :SlimuxREPLSendSelection<CR>
autocmd FileType python nmap <buffer> <silent> <CR> :SlimuxREPLSendLine<CR>
autocmd FileType python nmap <buffer> <silent> <C-CR> :mark '<CR>vii:SlimuxREPLSendSelection<CR>''
"autocmd FileType python nmap <buffer> <silent> <S-CR> ?function<CR>V%<CR><ESC>:noh<CR>
autocmd FileType python nmap <buffer> <silent> <S-CR> :mark '<CR>vip<CR>''
